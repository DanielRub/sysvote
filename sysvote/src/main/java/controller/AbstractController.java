...
public abstract class AbstractController<T> implements Serializable {
    ...
    public T getSelected() {
        if (selected == null) {
            try {
                T newItem = itemClass.newInstance();
    ...
    public void save(ActionEvent event) {
        String msg = ResourceBundle.getBundle("resource/bundle").getString(itemClass.getSimpleName() + "Updated");
    ...
    public void saveNoFeedback(ActionEvent event) {
    ...
    public void saveNew(ActionEvent event) {
        String msg = ResourceBundle.getBundle("resource/bundle").getString(itemClass.getSimpleName() + "Created");
    ...
    public void delete(ActionEvent event) {
        String msg = ResourceBundle.getBundle("resource/bundle").getString(itemClass.getSimpleName() + "Deleted");
    ...
    public void deleteNoFeedback(ActionEvent event) {
